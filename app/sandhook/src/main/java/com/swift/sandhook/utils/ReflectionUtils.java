...
//bypass hidden api on Android 9 - 14+
public class ReflectionUtils {
    ...
    static {
        try {
            ...
            Log.e("ReflectionUtils", "error get methods via meta-reflection", e);
        }
    }
    ...
    public static boolean passApiCheck() {
        try {
            ...
            Log.w("ReflectionUtils", "passApiCheck via addWhiteList failed", throwable);
        }
        // Fallback: use HiddenApiBypass
        try {
            return com.lody.virtual.client.hiddenapibypass.HiddenApiBypass.exemptAll();
        } catch (Throwable t) {
            Log.e("ReflectionUtils", "All hidden API bypass failed", t);
            return false;
        }
    }
    ...
    public static void addReflectionWhiteList(String... memberSigs) throws Throwable {
        if (addWhiteListMethod == null) {
            throw new IllegalStateException("addWhiteListMethod is null — meta-reflection init failed");
        }

...
public class NativeMethods {
    ...
    public static void init() {
        ...
        if (gOpenDexFileNative == null) {
            // On Android 14+, DexFile internals may have changed.
            // Don't crash — the native engine will skip dex override if this is null.
            if (Build.VERSION.SDK_INT >= 34) {
                android.util.Log.w("NativeMethods", "Unable to find method " + methodName + " on API " + Build.VERSION.SDK_INT + " (non-fatal)");
            } else {

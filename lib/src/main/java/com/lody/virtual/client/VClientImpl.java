...
public final class VClientImpl extends IVClient.Stub {
    ...
    private void bindApplicationNoCheck(String packageName, String processName, ConditionVariable lock) {
        ...
        // On Android 14+ (API 34+), Epic/SandHook may crash due to ART changes.
        // Xposed is disabled by default on API 34+ via auto-created .disable_xposed file.
        // Users can re-enable from Settings at their own risk.
        if (enableXposed) {
            VLog.i(TAG, "Xposed is enabled (API " + Build.VERSION.SDK_INT + ").");
            try {
                ...
                VLog.e(TAG, "Xposed initialization failed (non-fatal)", e);
            }
        } else {
    ...
    private void startIOUniformer() {
        ...
        try {
            ...
            VLog.w(TAG, "setupVirtualStorage failed, skipping storage redirect", e);
        }
